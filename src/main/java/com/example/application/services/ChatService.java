...
import static com.example.application.util.Values.OPENAIKEY;
import static com.example.application.util.Values.GPT3_5;
...
public class ChatService {
    ...
    public void init() {
        ...
        var memory = TokenWindowChatMemory.
                withMaxTokens(2000,
                        new OpenAiTokenizer(GPT3_5));
